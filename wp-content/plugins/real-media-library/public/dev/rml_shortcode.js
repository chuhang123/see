...
var _tinymce = __webpack_require__(/*! tinymce */ "tinymce");
...
function submit(_ref) {
    ...
    if (fid > -1) {
         ...
         */
        _util.hooks.call('shortcode/dialog/insert', [sdata, data], this);
...
_tinymce2.default.PluginManager.add(TAG, function (editor, url) {
    // Command
    editor.addCommand('folder_gallery_popup', function () {
        var _ref2 = _asyncToGenerator( /*#__PURE__*/_regenerator2.default.mark(function _callee(ui, v) {
                ...
                while (1) {
                    switch (_context.prev = _context.next) {
                        ...
                        case 3:
                            ...
                            // Prepare dialog
                            _ref4 = v || {}, _ref4$fid = _ref4.fid, fid = _ref4$fid === undefined ? '' : _ref4$fid, _ref4$link = _ref4.link, link = _ref4$link === undefined ? '' : _ref4$link, _ref4$columns = _ref4.columns, columns = _ref4$columns === undefined ? '3' : _ref4$columns, _ref4$orderby = _ref4.orderby, orderby = _ref4$orderby === undefined ? '' : _ref4$orderby, _ref4$size = _ref4.size, size = _ref4$size === undefined ? '' : _ref4$size, columnsValue = [1, 2, 3, 4, 5, 6, 7, 8, 9].map(function (i) {
                                return { text: '' + i, value: '' + i };
                            }), mce = _rmlopts2.default.mce;
                            ...
                            _util.hooks.call('shortcode/dialog/open', [options, editor]);
    ...
    // Add tinymce button
    _rmlopts2.default && editor.addButton(TAG, {
        icon: ' rmlicon-gallery',
        tooltip: _rmlopts2.default.mce.mceButtonTooltip,
