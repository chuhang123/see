                        ...
                        <tr valign="top">
                            ...
                            <td>
                                <ul>
                                    <li>
                                        <label for="ie">
                                            <input type="checkbox" id="ie" name="abc_show[ie]" value="https://support.microsoft.com/zh-cn/help/18520/download-internet-explorer-11-offline-installer" <?php echo ! empty( $abc['show_browser']['ie'] ) ? 'checked="checked"' : ''; ?> /> <?php _e( 'Internet Explorer', 'advanced-browser-check' ); ?>
                                        </label>
                                    </li>
                                    <li>
                                        <label for="edge">
